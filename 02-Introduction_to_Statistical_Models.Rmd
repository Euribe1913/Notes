...
* The line $\text{Price} = -485 + 0.5328 \times \text{Square Feet}$ is considered the "line of best fit" in the sense that it minimizes the sum of the squared residuals. 
...
### LSE in Simple Linear Regression
...
| 2 | Waterfront |`r SSR_wf` | `r SST-SSR_wf` | `r (SST-SSR_wf)/SST` |
| 3 | Sq. Ft. and Waterfront |`r SSR_wf_sqft` | `r SST-SSR_wf_sqft` | `r (SST-SSR_wf_sqft)/SST` |
| 4 | Sq. Ft., Waterfront, and Interaction | `r SSR_int` | `r SST-SSR_int` | `r (SST-SSR_int)/SST` |
